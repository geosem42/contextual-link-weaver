...
2. **Find related posts** — When editing a post, click "Find Related Posts" in the Interpost sidebar. The plugin embeds your draft content and uses cosine similarity to find the most semantically related posts — no AI call needed for this step.
